...
class LoraConfig(PeftConfig):
    ...
    Args:
        ...
        init_lora_weights (`bool` | `Literal["gaussian", "olora", "svdora", "loftq"]`):
            ...
            `'olora'` to use OLoRA initialization. 
    ...
    init_lora_weights: bool | Literal["gaussian", "olora", "loftq","svdora"] = field(
        default="guassian",
        metadata={
            "help": (
    ...
    def __post_init__(self):
        ...
        # Using post training conversion of modified base weights to restore their initial values (SVDoRA, OLoRA) cannot
        ...
        if (
            ...
            and (
                (isinstance(self.init_lora_weights, str) and (self.init_lora_weights.startswith("svdora")))
            ...
            msg = (
                ...
                "base weights (SVDoRA, OLoRA) means that you won't be able to pass "
