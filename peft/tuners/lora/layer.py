...
class LoraLayer(BaseTunerLayer):
    ...
    def update_layer(
        self, adapter_name, r, lora_alpha, lora_dropout, init_lora_weights, use_rslora, use_dora: bool = False,use_svdora: bool = False,
    ):
        ...
        if isinstance(init_lora_weights, str) and init_lora_weights.startswith("svdora"):
            with gather_params_ctx(self.get_base_layer().weight):
                self.svdora_init(adapter_name, init_lora_weights)
       ...
       # if use_svdora:
       #     self.svdora_init(adapter_name)
       #     self.use_svdora[adapter_name] = True
       # else:
       #     self.use_svdora[adapter_name] = False
    ...
    def svdora_init(self, adapter_name,init_lora_weights):
        print("svdora正在被启动")
